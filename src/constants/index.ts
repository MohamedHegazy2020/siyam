...
import AbeerSyam from '../assets/images/AbeerSiyam.png';
...
export { property1, property2, property3, ibrahimSyam, AbeerSyam, logo, logoFull, factory1 ,usersIcon ,chairman, qualityPolicy ,group1 ,group2};
